...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main" style="overflow-y: hidden;">
	...
	<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main" style="height: 100%;">
		<ul class="navbar-nav">
			<li class="nav-item">
				<a class="nav-link text-white " href="http://localhost/kaiac_canoe/admin">
			...
			<li class="nav-item">
				<a class="nav-link text-white " href="http://localhost/kaiac_canoe/eventscomeing">
					<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
			...
			<li class="nav-item">
				<a class="nav-link text-white " href="http://localhost/kaiac_canoe/descriptionath">
					<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">

					</div>
					<span class="nav-link-text ms-1">Description Athlete</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link text-white " href="http://localhost/kaiac_canoe/descriptionhome">
					<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
