		...
		<div class="row" style="padding-left: 20%;">
			...
			<div class="col-md-3">
				...
				<div class="col-md-12" style="padding-right: 200px">
					...
					<button type="submit" name="add_event" value="add" class="btn btn-primary"  style="float: right; background-color: gray;">Add Event</button>
				</div>
				</div>
	</form>
</div>
					...
					<div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up">
						<div class="member">
							...
							<div class="member-info">
								...
								<div class="row">
									<div class="col-6">
								<a href="http://localhost/kaiac_canoe/registerevent/<?php echo $event['ID_Event'];?>" class="button" type="submit" style="color: azure;">Register</a>
									</div>
									<div class="col-6">
								<a href="http://localhost/kaiac_canoe/startlist/<?php echo $event['ID_Event'];?>" class="button" type="submit" style="color: azure;">View</a>
									</div>
								</div>
								<div style="display: inline-flex">
									<a href="http://localhost/kaiac_canoe/editevent/<?php echo $event['ID_Event'];?>" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3"  title="edit">
									...
									<a href="http://localhost/kaiac_canoe/delevent/<?php echo $event['ID_Event'];?>" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3"  title="delete">
							<span class="svg-icon svg-icon-md svg-icon-primary">
						...
						<div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up">
							<div class="member">
								...
								<div class="member-info">
									...
									<div style="display: inline-flex">
										<a href="http://localhost/kaiac_canoe/editevent/<?php echo $events['ID_Event'];?>" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3"  title="edit">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
										...
										<a href="http://localhost/kaiac_canoe/delevent/<?php echo $events['ID_Event'];?>" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3"  title="delete">
							<span class="svg-icon svg-icon-md svg-icon-primary">
